          ...
          >
            ...
            >
              <Ionicons
                ...
                size={22}
                color={!item.leido ? "#0891b2" : "#9ca3af"}
              />
            </View>
...
const styles = StyleSheet.create({
  ...
  notiNoLeida: {
    backgroundColor: "#ecfeff", // Un morado muy clarito que combina con tu #7c3aed
    borderWidth: 1,
    borderColor: "#a5f3fc",
  },
  iconoContainer: {
